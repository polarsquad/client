	...
	function($rootScope, $timeout, icSearchResults, icMainMap, icMapItemMarker, icMapClusterMarker, icMapExpandControl, icMapSpinnerControl, icSite){
		return {
			...
			link: function(scope, element, attrs){
				...
				//todo rmeove map, when element is destroyed
				...
				// 	],
				// 	view: new ol.View({
				// 		center: 			ol.proj.fromLonLat(icMainMap.default.center),
				// 		zoom:				10,
				// 		zoom:				10,
				// 		enableRotation: 	false,
				// 		maxZoom:			28,
				// 		//extent:				[13.80, 52.80, 13.00, 52.20]
				// 	})
				// });
				...
				var view = new ol.View({
					...
					// minZoom:			0,
					// maxZoom:			28,
					extent:				ol.proj.transformExtent([13.80, 52.80, 13.00, 52.20], 'EPSG:4326', 'EPSG:3857'),
					enableRotation: 	false,
				});
				...
				fetch('https://openmaptiles.github.io/positron-gl-style/style-cdn.json').then(function(response) {
				...
				// // console.warn('FREE key for tilehosting, do not use commercially!')
				
				// // L.vectorGrid.protobuf("https://free-0.tilehosting.com/data/v3/{z}/{x}/{y}.pbf.pict?key={key}", {
				// // 	key: 'Xf9Q8QSYcxigsq98PRDp',
